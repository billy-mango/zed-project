...
document.addEventListener('DOMContentLoaded', (event) => { //Phone button funtionality
    const button = document.getElementById('phonebtn');
    button.addEventListener('click', () => {
        window.location.href = 'phonesignin.html';
    });
});
